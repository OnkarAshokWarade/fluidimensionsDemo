      ...
      case 'technical':
        return (
          <div className="text-gray-600 leading-relaxed text-sm sm:text-base">
            <p className="mb-4">Our technical approach combines advanced numerical methods, high-performance computing, and rigorous validation.</p>
            <ul className="list-disc pl-5 sm:pl-6 space-y-2">
              <li>Custom meshing strategies (structured, unstructured, hybrid)</li>
              <li>State-of-the-art solver selection (ANSYS Fluent, OpenFOAM, COMSOL)</li>
              <li>Parallel computation and HPC clusters</li>
              <li>Validation against experimental and field data</li>
              <li>Parametric studies and Design of Experiments (DoE)</li>
            </ul>
          </div>
        );
      default:
      ...
      <div className="pt-20 sm:pt-24 pb-12 sm:pb-16 bg-brand-bg min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-12 relative z-10">
          ...
          <div className="flex flex-wrap items-center gap-2 sm:gap-4 mb-6 sm:mb-8 text-xs sm:text-sm">
            ...
            <span className="text-gray-300">/</span>
            <span className="text-primary font-medium truncate max-w-[150px] sm:max-w-xs">{service.title}</span>
          </div>
            ...
            <div className="lg:w-2/3">
              <div className="bg-white rounded-2xl sm:rounded-3xl shadow-sm border border-gray-100 p-5 sm:p-6 md:p-8 lg:p-10">
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6 mb-6 sm:mb-8">
                  <div className={`w-14 h-14 sm:w-16 sm:h-16 rounded-2xl bg-gradient-to-tr ${service.color} flex items-center justify-center text-white shadow-lg flex-shrink-0`}>
                  ...
                  <div>
                    ...
                    <p className="text-gray-500 text-sm sm:text-base mt-1">{service.shortDesc}</p>
                  </div>
                </div>
            ...
            <div className="lg:w-1/3">
              <div className="sticky top-24 lg:top-32">
                <div className="bg-white rounded-2xl sm:rounded-3xl shadow-sm border border-gray-100 p-5 sm:p-6">
                  ...
                  <div className="max-h-[300px] sm:max-h-[420px] overflow-y-auto pr-1 sm:pr-2 custom-scrollbar">
                    <div className="space-y-3 sm:space-y-4">
                      {otherServices.map((s) => {
                        const Icon = iconMap[s.icon] || iconMap.IoAnalyticsOutline;
                        return (
                          <Link
                            key={s.id}
                            to={`/services/${s.id}`}
                          ...
                          >
                            <div
                              className={`w-8 h-8 sm:w-10 sm:h-10 rounded-lg sm:rounded-xl bg-gradient-to-tr ${s.color} flex items-center justify-center text-white shadow-sm flex-shrink-0`}
                            >
                ...
                <div className="mt-4 sm:mt-6 bg-gradient-to-br from-primary to-secondary rounded-2xl sm:rounded-3xl p-5 sm:p-6 text-white shadow-lg">
                  <h4 className="font-heading font-bold text-base sm:text-lg mb-2">Need a Custom Solution?</h4>
                  <p className="text-xs sm:text-sm text-white/70 leading-relaxed mb-3 sm:mb-4">
                    Our engineering team is ready to discuss your specific simulation needs.
                  </p>
                  <Link
                    to="/#contact"
